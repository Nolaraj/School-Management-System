...
def date_time1():
    date_time = datetime.datetime.now().strftime('%Y') + "/" + datetime.datetime.now().strftime('%m') + "/" + datetime.datetime.now().strftime('%d') + "//" + datetime.datetime.now().strftime('%H') + ":" + datetime.datetime.now().strftime('%M') + ":" + datetime.datetime.now().strftime('%S')
    return date_time
...
def framework(root):
        ...
        def date_converter_returning_age(provided_year, provided_month1, provided_day, now_year, now_month, now_day):
            ...
            if  (((provided_month1 == 1 or provided_month1 == 2) or (provided_month1 == 3 or provided_month1 == 4)) or ((provided_month1 == 5 or provided_month1 == 6) or (provided_month1 == 7 or provided_month1 == 8))) or ((provided_month1 == 9 or provided_month1 == 10) or (provided_month1 == 11 or provided_month1 == 11)):
        ...
        def new_registration_event(event):
            def student_to_db(event):
                ...
                sc = str(student_eyear.get() % 100) + student_gfather.get()[0] + student_father.get()[0] + \
                               student_name.get()[0]
                composite_datas = [sc, date_time, s0, s1, s2, s3, s4, s4a, s4b, s5, s5a, s5b, s6, s6a, s6b, s7, s8, s9, s10, s11, s12]

                titles = ["S.N.", "Student Code", "Date/Time of Entry", "Current Status", "Name of the Student", "Class", "Gender", "Date of Birth"," "," ", "Permanent Location", " ", " ", "Temporary Location", " ", " ", "Father's Name", "Mother's Name", "Grand Father's Name", "Enrollment Year", "Previous School", "Need of Hostel's Accomodation?"]
                dob = ["Year", "Month", "Day"]
        ...
        def existing_record_event(event):
            ...
            options_search = ("", "Search by Name", "Search by Class", "Search by Registration Year", "Search by Permanent Address",
            ...
            def search_student(event):
                ...
                search_frame2.grid(row=1, column=0, sticky="ew")

                search_main_label = Label(search_frame1, text="Search Results", font=("verdana", 12), bg="orange", width=50)
                search_main_label.grid(row=0, column=0, columnspan=7, sticky="ew")
                view_title1 = Label(search_frame1, text="Actions", font=("verdana", 10), width=13)
                view_title1.grid(row=1, column=0, sticky="ew")
                view_title1 = Label(search_frame1, text="S.N.", font=("verdana", 10), width=3)
                view_title1.grid(row=1, column=1, sticky="ew")
                view_title1 = Label(search_frame1, text="Student Code", font=("verdana", 10), width=11)
                view_title1.grid(row=1, column=2, sticky="ew")
                view_title1 = Label(search_frame1, text="Name", font=("verdana", 10), width=17)
                view_title1.grid(row=1, column=3, sticky="ew")
                view_title1 = Label(search_frame1, text="Class", font=("verdana", 10), width=5)
                view_title1.grid(row=1, column=4, sticky="ew")
                view_title1 = Label(search_frame1, text="Father's Name", font=("verdana", 10), width=15)
                view_title1.grid(row=1, column=5, sticky="ew")
                view_title1 = Label(search_frame1, text="Enrollment Year", font=("verdana", 10), width=16)
                view_title1.grid(row=1, column=6, sticky="ew")
                ...
                def button_creator(student_classe, filename, counter):
                    ...
                    text6 = result_sheet["C13"].value
                    def search_navi(event, s_list):
                        s_path = s_list[0]
                        s_filename = s_list[1]
                        os.chdir(s_path)
                        ...
                        def details(event, opinion, list):
                            ...
                            details_text = Text(details_frame1, width=715, font=("verdsns", 10))
                            ...
                            if opinion == "Identity":
                                ...
                                age = date_converter_returning_age(ws_details["C7"].value, ws_details["D7"].value, ws_details["E7"].value, year_today,
                        ...
                        status.bind("<Button-1>", lambda event, opinion="Status", list=s_list:details(event, opinion, list))
                        identity = Button(existing_navigation2, text="Identity", font=("verdana", 10),
                                          fg="black",
                                          bg="bisque", pady=5, border=1, relief=GROOVE)
                        identity.grid(row=8, column=0, columnspan=5, sticky="ew")
                        identity.bind("<Button-1>", lambda event, opinion="Identity", list=s_list:details(event, opinion, list))
                        grades_scholarships = Button(existing_navigation2, text="Grades and Scholarships",
                                                     font=("verdana", 10), fg="black", bg="bisque", pady=5, border=1, relief=GROOVE)
                        grades_scholarships.grid(row=9, column=0, columnspan=5, sticky="ew")
                        grades_scholarships.bind("<Button-1>", lambda event, opinion="Grades and Scholarships", list=s_list:details(event, opinion, list))
                        ...
                        fees_charges.bind("<Button-1>", lambda event, opinion="Fees and Charges", list=s_list:details(event, opinion, list))
                        remarks = Button(existing_navigation2, text="Remarks", font=("verdana", 10),
                                         fg="black", bg="bisque", pady=5, border=1, relief=GROOVE)
                        remarks.grid(row=11, column=0, columnspan=5, sticky="ew")
                        remarks.bind("<Button-1>", lambda event, opinion="Remarks", list=s_list:details(event, opinion, list))
                        ...
                        graphical_records.bind("<Button-1>", lambda event, opinion="Graphical Records", list=s_list:details(event, opinion, list))
                        ...
                        hostel.bind("<Button-1>", lambda event, opinion="Hostel Provisions", list=s_list:details(event, opinion, list))


                    frame_searched = Frame(search_frame2)
                    frame_searched.pack(side=TOP, fill=X)
                    view_button = Button(frame_searched, text="View/Modify", width=13)
                    view_button.grid(row=0, column=0)
                    slist = [fixed_path, filename]
                    view_button.bind("<Button-1>", lambda event, s_list=slist: search_navi(event, s_list))

                    view_label = Label(frame_searched, text=text1, font=("verdana", 10), width=3)
                    view_label.grid(row=0, column=1)
                    view_label = Label(frame_searched, text=text2, font=("verdana", 10), width=11)
                    view_label.grid(row=0, column=2)
                    view_label = Label(frame_searched, text=text3, font=("verdana", 10), width=17)
                    view_label.grid(row=0, column=3)
                    view_label = Label(frame_searched, text=text4, font=("verdana", 10), width=5)
                    view_label.grid(row=0, column=4)
                    view_label = Label(frame_searched, text=text5, font=("verdana", 10), width=15)
                    view_label.grid(row=0, column=5)
                    view_label = Label(frame_searched, text=text6, font=("verdana", 10), width=16)
                    view_label.grid(row=0, column=6)
        ...
        def academic_input(event):
            ...
            def excel_input(event):
                ...
                def generate_sheets(event):
                    def generator(event, c_name):
                        pass

                    excel_2 = Frame(navigation_pane_frame, width=250, height=470, relief=FLAT)
                    excel_2.grid(row=0, column=0, sticky="nsew")

                    existing_record = Button(excel_2, text="Pre-Nursery", font=("verdana", 10), width=30,
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="Pre-Nursery": generator(event, c_name))
                    existing_record.grid(row=0, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Nursery", font=("verdana", 10),
                                             fg="black", bg="bisque",  border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="Nursery": generator(event, c_name))
                    existing_record.grid(row=1, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="LKG", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="LKG": generator(event, c_name))
                    existing_record.grid(row=2, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="UKG", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="UKG": generator(event, c_name))
                    existing_record.grid(row=3, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-1", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="1": generator(event, c_name))
                    existing_record.grid(row=4, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-2", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="2": generator(event, c_name))
                    existing_record.grid(row=5, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-3", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="3": generator(event, c_name))
                    existing_record.grid(row=6, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-4", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="4": generator(event, c_name))
                    existing_record.grid(row=7, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-5", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="5": generator(event, c_name))
                    existing_record.grid(row=8, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-6", font=("verdana", 10),
                    fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="6": generator(event, c_name))
                    existing_record.grid(row=9, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-7", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="7": generator(event, c_name))
                    existing_record.grid(row=10, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-8", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="8": generator(event, c_name))
                    existing_record.grid(row=11, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-9", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="9": generator(event, c_name))
                    existing_record.grid(row=12, column=0, sticky="ew")

                    existing_record = Button(excel_2, text="Class-10", font=("verdana", 10),
                                             fg="black", bg="bisque", border=1, relief=GROOVE)
                    existing_record.bind("<Button-1>", lambda event, c_name="10": generator(event, c_name))
        ...
        def new_registration_event1(event):
            def teacher_to_db(event):
                ...
                composite_title = ["S.N.", "Name of the Teacher", "Age", "Gender", "Date of Birth"," ", " ",
                               "Marital Status", "Permanent Address", " ", " ", "Temporary Address", " ", " ", "Contact Number",
                               "Secondary Contact Number",
                               "E-mail Address", "Facebook ID", "Academic Qualification"," ", " "," ", " ", "Experience and Eligibility",
                ...
                def composite_writer():
                    ...
                    text = teacher_name.get() + str(teacher_age.get()) +".xlsx  File has been created in" + date_time + " \n"
        ...
        bottom_frame = Frame(frame, height=20, bd=0)
        ...
        act_text = Text(action_progress, wrap='word', font=('verdana', 10), state='disabled', width=32, yscrollcommand=act_scroll.set)
        ...
        detail_pane_frame1 = Frame(pane_frame, bg="lightcyan", width=715, height=470)
        detail_pane_frame1.place(x=255, y=0)
        maincanvas = Canvas(detail_pane_frame1, width=695, height=470)
        ...
        detail_pane_frame = Frame(detail_pane_frame2, relief=FLAT, bg="lightcyan", width=715, height=470)
        detail_pane_frame.pack(fill=BOTH)
        detail_pane_frame.rowconfigure(0, weight=1)
        detail_pane_frame.columnconfigure(0, weight=1)

        # ------------Gadgets and Labels
        welcome_text = Label(top_frame, text=f'Welcome to the Management System of {school_name}',
